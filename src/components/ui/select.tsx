...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-3 rounded-lg border-2 border-gray-200 bg-background text-foreground px-4 py-3 text-base",
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-5 text-muted-foreground transition-transform duration-200 data-[state=open]:rotate-180" />
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "overflow-x-hidden overflow-y-auto rounded-xl border border-gray-200 bg-background text-foreground shadow-xl",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-3 rounded-lg py-2.5 px-3 text-sm text-gray-900",
        "transition-colors duration-150 outline-hidden select-none",
        "hover:bg-gray-50 focus:bg-primary/5 focus:text-primary",
